        ...
        if (imageInput) {
            imageInput.onchange = function() {
                ...
                if (file) {
                    ...
                    reader.onload = function(e) {
                        ...
                        console.log("✅ 이미지 선택됨 for qid", block.dataset.qid, file);
                    };
            ...
            if (deleteImageBtn) {
                deleteImageBtn.onclick = function(e) {
                    e.preventDefault();
                    imageInput.value = "";
                    block.querySelector(".image-preview-wrapper").style.display = "none";
                    console.log("✅ 이미지 제거됨 for qid", block.dataset.qid);
                    debounceAutoSave();
                };
            }
        }
